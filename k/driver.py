...
def parse_args():
	...
	parser.add_argument('--num_hidden', type=int, default=512, help='units of hidden layer')
	parser.add_argument('--num_blocks', type=int, default=10, help='the number of residual blocks')
	parser.add_argument('--batch_size', type=int, default=512, help='batch size')
	parser.add_argument('--num_iters', type=int, default=500, help='the number of iterations')
	parser.add_argument('--lr_rate', type=float, default=0.0001, help='step size for optimization')
	parser.add_argument('--lr_decay', type=float, default=0.9, help='decay rate after each 10000 iterations')
...
def main():
	...
	if pde_type == 'Diffusion':
		...
		femsol_path = 'E:\\OneDrive - shanghaitech.edu.cn\\master\\Programs\\deep-galerkin-method\\square_diffq2sol.mat'
		grid_path = 'E:\\OneDrive - shanghaitech.edu.cn\\master\\Programs\\deep-galerkin-method\\squarediff_grid.mat'
